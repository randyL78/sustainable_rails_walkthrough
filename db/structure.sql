...
--
-- Name: COLUMN addresses.street_name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.addresses.street_name IS 'Street part of the address';
...
COMMENT ON COLUMN public.addresses.zip IS 'Postal or zipcode of this address';
...
COMMENT ON COLUMN public.manufacturers.name IS 'Name of the manufacturer';
